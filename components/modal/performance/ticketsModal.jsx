...
export function PerformanceTicketsModal({ handleClose, show }) {
  const dispatch = useDispatch();

  const {id, name} = useSelector(
    (state) => state.showHideModal.performanceTicketsData
  );
          ...
          <>
            ...
            rowData?.tickets !== 0 ? (
              <Button
                ...
                id="forgetButton"
                onClick={() => {
                  dispatch(showModal({ modal: "performance/ticket/purchase", data: rowData }));
                }}
              >
                {rowData?.tickets}
              </Button>
          ...
          <>
            ...
            rowData?.minTime !== 0 ? (
              <Button
                ...
                id="forgetButton"
                onClick={() => {
                  dispatch(showModal({ modal: "performance/ticket/firstPurchase", data: rowData }));
                }}
              >
                {rowData?.minTime}
              </Button>
          ...
          <>
            ...
            rowData?.maxTime !== 0 ? (
              <Button
                ...
                id="forgetButton"
                onClick={() => {
                  dispatch(showModal({ modal: "performance/ticket/lastPurchase", data: rowData }));
                }}
              >
                {rowData?.maxTime}
              </Button>

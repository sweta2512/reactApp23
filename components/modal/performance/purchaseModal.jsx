...
const PerformancePurchaseModal = ({ handleClose, show }) => {
          ...
          <>
            ...
            rowData?.tickets !== 0 ? (
              <Button
                ...
                id="forgetButton"
                onClick={() => {
                  dispatch(showModal({ modal: "performance/purchase/purchase", data: rowData }));
                }}
              >
                {rowData?.tickets}
              </Button>
          ...
          <>
            ...
            rowData?.minTime !== 0 ? (
              <Button
                ...
                id="forgetButton"
                onClick={() => {
                  dispatch(showModal({ modal: "performance/purchase/firstPurchase", data: rowData }));
                }}
              >
                {rowData?.minTime}
              </Button>
          ...
          <>
            ...
            rowData?.maxTime !== 0 ? (
              <Button
                ...
                id="forgetButton"
                onClick={() => {
                  dispatch(showModal({ modal: "performance/purchase/lastPurchase", data: rowData }));
                }}
              >
                {rowData?.maxTime}
              </Button>
...
export default React.memo(PerformancePurchaseModal);

...
export function NoOfOverLimitModal({ handleClose, show  }) {
const [history1, setHistory]= useState([]);
const {errorHistoryData} =  useSelector((state)=>state.overLimitAccount);
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            <span>Limit error history for</span>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
